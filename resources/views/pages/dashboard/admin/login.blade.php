...
<body>
    <x-layout-login title="Login">
        <div
            ...
            <div class="">
                <img src="/assets/logo_polres.png" class="w-1/2 h-1/2 flex m-auto hover:animation-all"  alt="">
            </div>
            <p class="font-poppins font-semibold text-3xl text-white text-center">Selamat Datang</p>
            <p class="font-poppins font-normal text-lg text-white">Halaman Login User</p>
            <form class="w-full space-y-2" action="">
                ...
                <p class="font-poppins font-normal text-sm text-white text-end"><a href="/Lupa-Password">Forget?</a></p>
                <a href="/BagianInformasi">
                    <button type="button"
                        class="mt-5 bg-[#FBB603] text-black w-1/2 flex justify-center items-center m-auto font-poppins font-semibold text-base py-2 mb-2 rounded-lg hover:ring-4 hover:ring-yellow-500 ">Login</button>
                </a>
            </form>
        </div>
        <script>
