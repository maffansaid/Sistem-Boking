...
<body>
    <x-layout-login title="Login">
        <div
            ...
            <p class="font-poppins font-normal text-lg text-white">Halaman OTP</p>
            <form class="w-full space-y-2" action="">
                <div>
                    <label for="email"
                        class="block ml-1 text-base text-white font-poppins font-normal">Otp</label>
