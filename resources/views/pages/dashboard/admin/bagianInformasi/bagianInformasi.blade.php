...
<body>
    ...
    <div class="min-h-screen bg-neutral-200 p-4 sm:ml-64">
        ...
        <div class="m-5 lg:m-20">
            <div class="m-auto mb-10 flex items-center justify-center text-center text-[30px] text-black font-bold">
                Daftar
                Informasi</div>
                            ...
                            <tr class="border-b border-[#FBB603] bg-white">
                                ...
                                <td class="px-6 py-4">
                                    <img src="{{ $data['gambar'] }}" alt=""
                                        class="m-auto flex h-10 w-10 md:h-20 md:w-32">
                                </td>
                                <td class="px-6 py-4">
                                    <div class="m-auto flex justify-center justify-items-center gap-2 text-center">
                                        <button onclick="showImage('{{ $data['gambar'] }}')" title="lihat"
                                            class="rounded-md bg-[#FA8F21] p-1 hover:bg-[#D87815]">
                                            <x-svg-lihat />
                                        </button>
                    ...
                    <div id="popup-modal" tabindex="-1"
                        ...
                        <div class="relative w-[90%] rounded-lg bg-white p-4 shadow md:w-[30%]">
                            <button type="button" onclick="closeDeleteModal()"
                                class="absolute right-3 top-3 rounded-lg bg-transparent p-2 text-gray-400 hover:bg-gray-200">
                            ...
                            <div class="text-center">
                                ...
                                <p class="mb-5 text-lg text-black">Yakin ingin hapus data?</p>
                                ...
                                <button onclick="confirmDelete()"
                                    class="rounded-md bg-red-600 px-5 py-2 text-white hover:bg-red-800 transition transform duration-300 hover:scale-110">Ya</button>
                                <button onclick="closeDeleteModal()"
                                    class="ms-3 rounded-md bg-gray-200 px-5 py-2 text-black transition transform duration-300 hover:scale-110">Tidak</button>
                            </div>
                        </div>
                    </div>
            ...
            <div id="crud-modal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative max-h-full w-full max-w-md p-4">
                    ...
                    <div class="relative rounded-lg bg-white shadow">
                        <!-- Modal header -->
                        <div class="flex items-center justify-between rounded-t border-b bg-[#800000] p-4 md:p-5">
                            <h3 class="text-lg font-semibold text-white">
                                Tambah Data
                            </h3>
                            <button type="button"
                                class="ms-auto inline-flex h-8 w-8 items-center justify-center rounded-lg bg-transparent text-sm text-white hover:bg-gray-200 hover:text-gray-900"
                        ...
                        <form method="POST" enctype="multipart/form-data" class="p-4 md:p-5">
                            ...
                            <div class="mb-4 grid grid-cols-2 gap-4">
                                <div class="col-span-2">
                                    <label for="name"
                                        class="mb-2 block text-sm font-medium text-gray-900">Judul</label>
                            ...
                            <div class="grid grid-cols-1">
                                ...
                                <input
                                    ...
                                    aria-describedby="file_input_help" id="file_input" name="gambar" type="file"
                                        ...
                                        <div class="relative rounded-lg bg-white shadow">
                                            ...
                                            <div class="p-4 text-center md:p-5">
                                                <div class="bg-transparent">
                                                    <svg class="mx-auto mb-4 h-12 w-12 bg-transparent" fill="#99FF33"
