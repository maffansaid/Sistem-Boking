            ...
            <div id="crud-modal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                        <!-- Modal header -->
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t bg-[#A40000]">
                        ...
                        <form class="p-4 md:p-5">
                            ...
                            <div class="grid grid-cols-1">
                                <label class="block text-sm font-medium text-gray-900 mb-2" for="file_input">Upload
                                    Poster</label>
                                <input
                            ...
                            <div class="flex justify-end">
                                <button type="button" data-modal-target="popUp-modal-simpan"
