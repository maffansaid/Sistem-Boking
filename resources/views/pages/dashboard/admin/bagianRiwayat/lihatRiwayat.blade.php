        ...
        <div class="m-5 lg:m-20">
            ...
            <div class="max-w-5xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden mt-4">
                ...
                <div class="bg-[#F8C104] px-6 py-4">
                    <h2 class="text-xl font-bold text-black text-center">Detail Riwayat</h2>
                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-4">
                                    <div class="bg-white rounded-lg p-4 shadow-sm">
                                        <h3 class="text-sm md:text-lg font-semibold text-black mb-3 border-b-2 pb-2">
