[12.50, 14/11/2024] Ando If'20: <!doctype html>
<html>
    ...
    <div class="min-h-screen bg-[#A40000] p-4 sm:ml-64">
        <div class="m-5 lg:m-20">
            ...
            <div class="flex justify-start">
                <a href="/BagianRiwayat" class="block rounded-lg bg-[#FBB603] px-5 py-2.5 text-sm font-bold text-black hover:bg-[#99FF33] focus:outline-none focus:ring-4 focus:ring-blue-300">
...
[12.51, 14/11/2024] Ando If'20: <!doctype html>
<html>
