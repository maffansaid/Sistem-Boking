...
<body>
    ...
    <div class="min-h-screen bg-neutral-200 p-4 sm:ml-64">
        <div class="rounded-lg bg-[#D9D9D9] text-center text-[24px] text-black lg:m-10">
            <div class="mx-auto max-w-full overflow-hidden rounded-lg bg-white shadow-lg">
                ...
                <div class="p-5">
                    <div class="grid grid-cols-3 gap-y-2 text-sm md:text-lg">
                        ...
                        <div class="flex flex-col items-start justify-between p-4 space-y-2 sm:hidden">
                            <span class="text-blue-600 text-sm block break-all w-full" id="virtual-account">
                                {{ session('pembayaran')['data']['pay_code'] ?? '' }}
                            </span>
                            <button class="rounded bg-[#99FF33] px-4 py-2 text-sm text-black hover:bg-[#85e62e] w-full">
                                Copy
                            </button>
                        </div>
                        <div class="lg:flex items-start md:items-center justify-between md:justify-start hidden">
                            <span class="text-blue-600 block" id="virtual-account">
                                {{ session('pembayaran')['data']['pay_code'] ?? '' }}
                            </span>
                        ...
                        <!-- <div class="flex flex-col md:flex-row items-start md:items-center justify-between md:justify-start p-4 space-y-2 md:space-y-0 md:space-x-4">
                            <span class="text-blue-600 text-sm md:text-base block break-all" id="virtual-account">
                                {{ session('pembayaran')['data']['pay_code'] ?? '' }}
                            </span>
                            <button class="rounded bg-[#99FF33] px-4 py-2 text-xs md:text-sm text-black hover:bg-[#85e62e] w-full md:w-auto">
                                Copy
                            </button>
                        </div> -->
                        ...
                        <div class="md:flex md:justify-end text-start">
                            <span class="font-medium">Tenggat Waktu</span>
                        </div>
                        <div class="flex justify-center">
                            <span class="font-medium">:</span>
                        </div>
                        <div class="md:flex md:justify-start text-end">
                            <span id="countdown" class="text-red-500">23:59</span>
                        </div>
                        <div id="expired-message" class="hidden text-red-500">
