    ...
    <div class="min-h-screen bg-[#A40000] p-4 sm:ml-64">
        <div class="m-5 rounded-lg bg-[#D9D9D9] text-center text-[24px] text-black lg:m-10">
            <div class="mx-auto max-w-full overflow-hidden rounded-lg bg-white shadow-lg">
                ...
                <div class="m-auto mb-4 flex items-center justify-center rounded-lg p-4 text-sm text-red-800" role="alert">
                    ...
                    <div>
                        <span class="font-medium">Perhatian ! </span>Jika anda sudah membayar, mohon muat ulang halaman ini
                    </div>
                </div>
                ...
                <div class="p-5">
                    <div class="grid grid-cols-3 gap-y-2">
                        ...
                        <div class="flex justify-start">
                            <span class="text-blue-600">Rp {{ number_format($pemesanan->pembayaran->harga, 0, '', '.') }}</span>
                        </div>
                        ...
                        <div class="flex justify-start">
                            <span class="">Bank {{ session('metode') === 'BRIVA' ? 'BRI' : (session('metode') === 'BNIVA' ? 'BNI' : 'BCA') }}</span>
                        </div>
                        ...
                        <div class="flex items-center justify-start">
                            <span class="text-blue-600" id="virtual-account">{{ session('pembayaran')['data']['pay_code'] ?? '' }}</span>
                            <button class="ml-2 rounded bg-[#99FF33] px-2 py-1 text-sm text-black hover:bg-[#99FF33]" onclick="copyToClipboard()">
                                Copy
                            </button>
                        </div>
                ...
                <div class="pb-5">
                    <div class="bg-transparent">
                        @if ($pemesanan->status)
                            <svg class="mx-auto mb-4 h-32 w-32 bg-transparent" fill="#99FF33" viewBox="-7.6 0 93.973 93.973" xmlns="http://www.w3.org/2000/svg">
                        ...
                        @else
                            <svg class="mx-auto mb-4 h-32 w-32 bg-transparent" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <path d="M18.364 8.05026L17.6569 7.34315C14.5327 4.21896 9.46734 4.21896 6.34315 7.34315C3.21895 10.4673 3.21895 15.5327 6.34315 18.6569C9.46734 21.7811 14.5327 21.7811 17.6569 18.6569C19.4737 16.84 20.234 14.3668 19.9377 12.0005M18.364 8.05026H14.1213M18.364 8.05026V3.80762" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                    </path>
                                </g>
                            </svg>
                        @endif
                ...
                <div class="flex justify-center">
                    <button type="button" data-modal-target="popUp-modal-simpan" data-modal-toggle="popUp-modal-simpan" class="mb-5 flex items-center gap-2 rounded-lg bg-[#FBB603] px-5 py-2.5 text-sm font-medium text-black hover:bg-[#99FF33] focus:outline-none focus:ring-4 focus:ring-blue-300">
                ...
                <div class="m-auto flex h-[50px] w-fit p-4 text-center">
                    <p class="typewriter text-sm text-gray-600" id="animated-text">Terima kasih telah bertransaksi dengan kami!</p>
                </div>
