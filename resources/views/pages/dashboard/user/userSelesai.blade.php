...
<body>
    ...
    <div class="p-4 sm:ml-64 bg-[#A40000] min-h-screen">
        <div class="m-5 lg:m-10 bg-[#D9D9D9] text-center text-[24px] text-black rounded-lg">
            <div class="max-w-full mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
                <div class="bg-[#99FF33] text-black text-center p-4">
                    <h2 class="text-2xl font-bold">Struk Transaksi</h2>
                </div>

                <div class="flex justify-center items-center p-4 mb-4 text-sm text-red-800 rounded-lg m-auto"
                    role="alert">
                ...
                <div class="p-5">
                    <div class="grid grid-cols-3 gap-y-2">
                        ...
                        <div class="flex justify-start">
                            <span class=" text-blue-600">Rp 1.000.000</span>
                        </div>
                        ...
                        <div class="flex justify-start items-center">
                            <span class=" text-blue-600" id="virtual-account">1234567890</span>
                            <button class="ml-2 px-2 py-1 bg-[#99FF33] text-black rounded hover:bg-[#99FF33] text-sm"
                        ...
                        <div class="flex justify-start">
                            <span class="">PT. Contoh Bersama</span>
                        </div>
...
<svg class="mx-auto mb-4 w-32 h-32 bg-transparent" fill="#99FF33" viewBox="-7.6 0 93.973 93.973"
                        ...
                        {{-- @elseif($status === 'sukses') --}}
                        <svg class="mx-auto mb-4 w-32 h-32 bg-transparent" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                ...
                <div class="flex justify-center">
                    <button type="button" data-modal-target="popUp-modal-simpan" data-modal-toggle="popUp-modal-simpan"
                        class="flex items-center gap-2 text-black bg-[#FBB603] hover:bg-[#99FF33] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-5">
                ...
                <div class="p-4 text-center w-fit m-auto flex h-[50px]">
                    <p class="text-sm text-gray-600 typewriter" id="animated-text">Terima kasih telah bertransaksi dengan kami!</p>
                </div>
