<button data-drawer-target="cta-button-sidebar" data-drawer-toggle="cta-button-sidebar" aria-controls="cta-button-sidebar"
    type="button"
    class="ms-3 mt-2 inline-flex items-center rounded-lg p-2 text-sm hover:bg-[#FBB603] focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-600 sm:hidden">
...
<aside id="cta-button-sidebar"
    ...
    aria-label="Sidebar">
    <div class="h-full overflow-y-auto bg-[#800000] px-3 py-4">
        ...
        <ul class="space-y-2 font-medium">
            <li class="pb-2">
                <a href="mailto:gorbulutangkislamsel@gmail.com" class="group items-center rounded-lg text-gray-900">
                    <img src="/assets/logo_polres.png" alt=""
                        class="m-auto flex h-[60px] w-[80px] items-center justify-center md:h-[100px] md:w-[140px]">
            ...
            <li>
                ...
                <a href="/BagianInformasi"
                    class="@if (in_array(Request::path(), $activePagePath1)) text-white rounded-lg bg-[#F8C104]
        @else
            hover:bg-[#F8C104] bg-neutral-100 @endif group flex items-center rounded-lg p-2 hover:text-white">
            ...
            <li>
                ...
                @endphp
                <a href="/BagianWaktu"
                    class="@if (in_array(Request::path(), $activePagePath2)) text-white rounded-lg bg-[#F8C104]
        @else
            hover:bg-[#F8C104] bg-neutral-100 @endif group flex items-center rounded-lg p-2 hover:text-white">
                    <svg class="h-5 w-5 flex-shrink-0 transition duration-75" viewBox="0 0 32 32" fill="currentColor"
            ...
            <li>
                ...
                <a href="/BagianPermintaan"
                    class="@if (in_array(Request::path(), $activePagePath3)) text-white rounded-lg bg-[#F8C104]
        @else
            hover:bg-[#F8C104] bg-neutral-100 @endif group flex items-center rounded-lg p-2 hover:text-white">
                    <svg fill="currentColor" viewBox="0 0 16 16" id="request-approval-16px"
                        class="h-5 w-5 flex-shrink-0 transition duration-75" aria-hidden="true"
            ...
            <li>
                ...
                <a href="/BagianRiwayat"
                    class="@if (in_array(Request::path(), $activePagePath4)) text-white rounded-lg bg-[#F8C104]
        @else
            hover:bg-[#F8C104] bg-neutral-100 @endif group flex items-center rounded-lg p-2 hover:text-white">
                    <svg class="h-5 w-5 flex-shrink-0 transition duration-75" aria-hidden="true" viewBox="0 0 512 512"
        ...
        <ul class="mt-4 space-y-2 border-t border-gray-200 pt-4 font-medium dark:border-gray-700">
            <li>
                <a href="/Logout"
                    class="group flex items-center rounded-lg bg-[#F8C104] p-2 text-black hover:bg-[#F8C104] hover:text-black">
                    <svg class="h-5 w-5 flex-shrink-0 transition duration-75" aria-hidden="true"
